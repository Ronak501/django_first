"""
Django settings for ronakwithDjango project.
...
SECRET_KEY = 'django-insecure-7xomf(v2+_lib=)_9_zs7-f0p6%km1tt(p_%%n2b&4c*nzem5b'
...
WSGI_APPLICATION = 'ronakwithDjango.wsgi.application'
